...
class Dig:
    def __init__(self, ip, port, tools_dir, timestamp):
        self.ip = ip
        self.port = port
        self.url = f"dns://{self.ip}:{self.port}"
    ...
    def run_dig(self):
        ...
        for test_func in tests:
            try:
                ...
                printerr(f"Error running {test_func.__name__}: {e}")
        ...
        try:
            ...
            printerr(f"Error writing results to {self.output_file}: {e}")
    ...
    def version_disclosure(self):
        ...
        result = execute_command(cmd, "Dig Version", self.output_file, self.url)
    ...
    def hostname_disclosure(self):
        ...
        result = execute_command(cmd, "Dig Hostname", self.output_file, self.url)
    ...
    def server_id_disclosure(self):
        ...
        result = execute_command(cmd, "Dig Server ID", self.output_file, self.url)
    ...
    def authors_disclosure(self):
        ...
        result = execute_command(cmd, "Dig Authors", self.output_file, self.url)
    ...
    def test_recursion_google(self):
        ...
        result = execute_command(cmd, "Dig Recursion Google", self.output_file, self.url)
    ...
    #     result = execute_command(cmd, "Dig Recursion CF", self.output_file, self.url)
    #
    #     if not result.get("success", False):
    #         return None
    #
    ...
    def test_amplification_any(self):
        ...
        result = execute_command(cmd, "Dig Amplification ANY", self.output_file, self.url)
    ...
    def test_amplification_txt(self):
        ...
        result = execute_command(cmd, "Dig Amplification TXT", self.output_file, self.url)
    ...
    def test_dnssec_amplification(self):
        ...
        result = execute_command(cmd, "Dig DNSSEC Amp", self.output_file, self.url)
    ...
    def test_zone_transfer_root(self):
        ...
        result = execute_command(cmd, "Dig AXFR Root", self.output_file, self.url)
    ...
    def test_zone_transfer_local(self):
        ...
        result = execute_command(cmd, "Dig AXFR Local", self.output_file, self.url)
    ...
    def test_zone_transfer_internal(self):
        ...
        result = execute_command(cmd, "Dig AXFR Internal", self.output_file, self.url)
    ...
    def test_zone_transfer_corp(self):
        ...
        result = execute_command(cmd, "Dig AXFR Corp", self.output_file, self.url)
    ...
    def test_tcp_fallback(self):
        ...
        result = execute_command(cmd, "Dig TCP Fallback", self.output_file, self.url)
    ...
    def test_edns_support(self):
        ...
        result = execute_command(cmd, "Dig EDNS Support", self.output_file, self.url)
    ...
    def test_edns_disable(self):
        ...
        result = execute_command(cmd, "Dig No EDNS", self.output_file, self.url)
    ...
    def test_reverse_lookup(self):
        ...
        result = execute_command(cmd, "Dig Reverse Lookup", self.output_file, self.url)
    ...
    def test_wildcard_query(self):
        ...
        result = execute_command(cmd, "Dig Wildcard", self.output_file, self.url)
    ...
    def test_mx_records(self):
        ...
        result = execute_command(cmd, "Dig MX Records", self.output_file, self.url)
    ...
    def test_ns_records(self):
        ...
        result = execute_command(cmd, "Dig NS Records", self.output_file, self.url)
    ...
    def test_soa_records(self):
        ...
        result = execute_command(cmd, "Dig SOA Records", self.output_file, self.url)
    ...
    def test_ipv6_query(self):
        ...
        result = execute_command(cmd, "Dig IPv6 Query", self.output_file, self.url)
    ...
    def test_long_domain_query(self):
        ...
        result = execute_command(cmd, "Dig Long Domain", self.output_file, self.url)
    ...
    def test_unusual_flags(self):
        ...
        result = execute_command(cmd, "Dig Unusual Flags", self.output_file, self.url)
    ...
    def test_cache_poisoning(self):
        ...
        result = execute_command(cmd, "Dig Cache Poisoning", self.output_file, self.url)
    ...
    def test_subdomain_enumeration(self):
        ...
        result = execute_command(cmd, "Dig Subdomain Enum", self.output_file, self.url)
    ...
    def test_dns_tunneling(self):
        ...
        result = execute_command(cmd, "Dig DNS Tunneling", self.output_file, self.url)
    ...
    def test_rate_limiting(self):
        ...
        cmd = f"dig @{self.ip} google.com A"
        result = execute_command(cmd, "Dig Rate Limiting", self.output_file, self.url)
